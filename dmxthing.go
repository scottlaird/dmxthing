...
func main() {
	...
	light1 := NewLightController(l, LeftTop, []Light{NewAeosLight(udmx, 1)})
	light2 := NewLightController(l, LeftMiddle, []Light{NewAeosLight(udmx, 3)})
	light3 := NewLightController(l, LeftBottom, []Light{NewAeosLight(udmx, 5)})
